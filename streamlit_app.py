...
st.title(":Gray[ChurnMaster: Predicting Customer Churn with Machine Learning]")
...
plt.hist([churned_gender,not_churned_gender],color=['green','yellow'],label=['Churned','Not-Churned'])
plt.xlabel('Gender')
plt.ylabel('Count')
